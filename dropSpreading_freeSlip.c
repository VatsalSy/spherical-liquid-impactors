/**
 * @file dropSpreading_freeSlip.c
 * @author Vatsal Sanjay (vatsalsanjay@gmail.com)
 * vatsalsanjay.com
 * Physics of Fluids
 * @date Sep 3, 2024
 * @version 1.0
 * Drop impacts on a surface where it can freely slip. 
 * This is a thought experiment, inspired by Wildeman, S., Visser, C. W., Sun, C., & Lohse, D. (2016). On the spreading of impacting drops. J. Fluid Mech., 805, 636-655.
 * This code will test the influence of f = 0 vs f = dirichlet(0) [dropSpreadingNonWetting_freeSlip.c](dropSpreadingNonWetting_freeSlip.c) on the drop spreading.
 * 
*/
