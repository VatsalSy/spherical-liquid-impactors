/**
 * @file dropSpreadingNonWetting_freeSlip.c
 * @author Vatsal Sanjay (vatsalsanjay@gmail.com)
 * vatsalsanjay.com
 * Physics of Fluids
 * @date Sep 3, 2024
 * @version 1.0
 * Drop impacts on a non-wetting surface where it can freely slip. 
 * To mimic non-wetting surface, we still keep an air layer between the drop and the surface. 
