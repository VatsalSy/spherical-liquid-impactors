/**
 * @file dropSpreadingNonWetting.c
 * @author Vatsal Sanjay (vatsalsanjay@gmail.com)
 * vatsalsanjay.com
 * Physics of Fluids
 * @date Sep 3, 2024
 * @version 0.2
 * Drop impacts on a non-wetting surface. To mimic non-wetting surface, we keep an air layer between the drop and the surface. 
 * 
*/
